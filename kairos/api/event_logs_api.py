...
from kairos.services import event_logs_service, cases_service, stream_service
...
event_logs_api.route('/<event_log_id>/status/stream',methods=['GET'])(stream_service.stream_project_status)
